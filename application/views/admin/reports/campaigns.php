		...
		<div class="box-header with-border">
			...
			<div class="row margin-bottom-20">
				<div class="col-md-12 text-right">
					<a href="<?= base_url('admin/reports_admin/campaigns_module') ?>" title="Novo" class="btn btn-success"><i class="fa fa-plus-square"></i> Novo</a>
				</div>
			</div> <br>
			...
			<table class="table table-hover table_list_data">
				...
				<?php foreach ($campaigns as $cp):?>
					<tr>
						<td class="text-center"><?= $cp->costumer_name?></td>
						<td class="text-center"><?= $cp->type?></td>
						<td class="text-center"><?= $cp->model?></td>
						<td class="text-center"><?= $cp->nome?></td>
