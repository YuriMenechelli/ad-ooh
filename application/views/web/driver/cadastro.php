...
<div class="container-fluid">
	<div class="container form-padding">
		<div class="text-center">
			<a href="<?= base_url()?>">
				<img class="img-fluid" src="assets\images\ad-ooh_logo_white.png" alt="">
			</a>
		</div>
		<div class="form-box">
			<div>
				...
				<form name="meu_form" method="POST" enctype="multipart/form-data" action="/forms/cadastro2.php">
					<div class="form-content">
						...
						<div class="form-group row">
							<div class="col-md-4">
								...
								<input type="text" class="form-control" id="veiculo_cidade" placeholder="Digite a cidade do veÃ­culo"
